-- Update entitlement snapshot to use quota_allocations ledger model
-- - Quotas are sourced from quota_allocations (trial/subscription/addon/rollover)
-- - Trial window is sourced from company_trials
-- - Usage continues to come from usage_counters + capacity tables
...
BEGIN
  ...
  -- Trial window from company_trials
  SELECT t.trial_start, t.trial_end
